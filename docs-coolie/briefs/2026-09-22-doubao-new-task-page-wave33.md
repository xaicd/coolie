...
## 0. Boss 09-22 23:42 OOB 「底层用咱现有接口，看看像豆包体验一样的开展设计开发」 + 23:43-23:45 发 2 张豆包截图
...
2. **看豆包体验** — 豆包 (boss 23:43-23:45 OOB 两张截图) UI 模式:

### 截图 1: 豆包主对话页 (Empty state)
- 顶部: ☰ 菜单 + 中间「电话」图标 + 右侧「网络」图标
- 中央: 大字「有什么我能帮你的吗?」
- 模式切换 pill: 「对话 / 工作」(豆包)
- 推荐问题: 4 张
- 快捷功能 row: 对话 / 录音转写 / AI 创作 / 拍题 (4 chip)
- 底部大按钮: 「按住说话」(voice 主输入)
- 底部辅助 row: 📷 相机 + ⌨️ 键盘 + ⊕ 加号

### 截图 2: 豆包左侧抽屉菜单 (从屏幕左缘右滑打开)
- 顶部: 搜索框 + 📝 编辑图标 + ☰ 菜单按钮
- 抽屉内容:
  - 头像 (豆包 AI)
  - 定时任务
